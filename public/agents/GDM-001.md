...
**Ajout observé :** Étude Apollo : capacité de tromperie stratégique observée dans des environnements construits à cet effet.

## État des preuves

- **Identifiant d’exécution :** Non établi dans cette fiche.
- **Modèle / checkpoint :** Gemini 1.5 Pro ; version technique exacte à vérifier.
