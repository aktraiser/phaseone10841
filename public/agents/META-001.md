...
L’étude rapporte une capacité de tromperie stratégique pour ce modèle. Cette fiche agrège des conditions et n’attribue pas tous les mécanismes à un même run.
...
**Ajout observé :** Étude Apollo : capacité de tromperie stratégique dans ces scénarios.

## État des preuves

- **Identifiant d’exécution :** Non établi dans cette fiche.
- **Modèle / checkpoint :** Llama 3.1 405B ; version technique exacte à vérifier.
